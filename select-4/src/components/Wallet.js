...
class Wallet extends Component {
  ...
  componentDidMount() {
    API.getTickets()
    .then(res => this.setState({ ticket1: res.data[0].number, ticket2: res.data[1].number, ticket3: res.data[2].number, }))
  ...
  return (
    ...
    <div className="bkGround">
      ...
      >
        ...
        If your any of your numbers match todays' drawing you'll take home $1000.
      </h1>
      <div
        style={{
          display: "flex",
